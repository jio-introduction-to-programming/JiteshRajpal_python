from assignment_dt import (datetime_to_str_1, datetime_to_str_2, datetime_to_str_3, datetime_to_str_4, datetime_to_str_5,
...
def test_datetime_to_str_2():
    assert datetime_to_str_2(date(2023, 7, 19)) == "23-07-19"

def test_datetime_to_str_3():
    assert datetime_to_str_3(date(2023, 7, 19)) == "July 19, 2023"

def test_datetime_to_str_4():
    assert datetime_to_str_4(date(2023, 7, 19)) == "Jul 19, 2023"

def test_datetime_to_str_5():
    assert datetime_to_str_5(date(2023, 7, 19)) == "19 July 2023"

def test_datetime_to_str_6():
    assert datetime_to_str_6(date(2023, 7, 19)) == "Wednesday July 19, 2023"

def test_datetime_to_str_7():
    assert datetime_to_str_7(date(2023, 7, 19)) == "Wed July 19, 2023"
